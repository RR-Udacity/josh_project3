...
| ------------ | ------------ | ------------ |
| *Azure Postgres Database* |  Basic Gen5 1vCore   |       $25.80       |
| *Azure Service Bus*   |    Basic     | $0.05 / million messages             |
| *Azure App Service Plan - Function*                   |  F1       |    $0.00          |
|*Azure App Service Plan - Web App*| B1 | $13.14|
